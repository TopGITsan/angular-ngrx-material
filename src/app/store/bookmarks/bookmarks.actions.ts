...
export const UPDATE_BOOKMARK = createAction('[Bookmark] Update bookmark', props<{ bookmark: Bookmark }>());

export const UPDATE_BOOKMARK_SUCCESS = createAction('[Bookmark] Update bookmark success');

export const UPDATE_BOOKMARK_FAILURE = createAction('[Bookmark] Update bookmark failure', props<{ error: string }>());
